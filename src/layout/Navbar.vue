<template>
  ...
  >
    <div
      class="flex items-center justify-between w-full px-3 mx-auto max-w-8xl lg:px-4"
    >
      <div class="flex items-center">
        ...
        >
          <svg
            ...
            :class="[isHamburgerHidden ? 'hidden' : '', 'w-6 h-6']"
            fill="currentColor"
            viewBox="0 0 20 20"
          ...
          <svg
            ...
            :class="[isMobileCloseHidden ? 'hidden' : '', 'w-6 h-6']"
            fill="currentColor"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
          >
        ...
        >
          ...
          <li class="mb-3 lg:px-2 xl:px-3 lg:mb-0">
            <a
              ...
              >Contributing</a
            >
            <!-- TODO: Add new 'Contributing' page -->
